class Calculator {
  ...
  updateDisplay() {
    this.currentOperandButtonTextElement.innerText = this.getDisplayNumber(
      this.currentOperand
    );
    if (this.operation != null) {
      this.previousOperandButtonTextElement.innerText = `${this.previousOperand} ${this.operation}`;
    } else {
